...
namespace BoatHUD {
    public class BoatHUD : OnixPluginBase {
        public static BoatHUD Instance { get; private set; } = null!;
        public static BoatHUDConfig Config { get; private set; } = null!;

        public BoatHUD(OnixPluginInitInfo initInfo) : base(initInfo) {
            Instance = this;
        ...
        protected override void OnLoaded() {
            ...
            Config = new BoatHUDConfig(PluginDisplayModule);
